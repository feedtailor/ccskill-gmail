...
echo "  3. User adds to PATH: export PATH=\"\$HOME/path/to/ccskill-gmail:\$PATH\""
echo "  4. User runs setup:           ccskill-gmail setup"
echo "  5. User registers an account: ccskill-gmail account add"
echo "  6. User registers the skill:  ccskill-gmail skill install"
