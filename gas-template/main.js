...
var POST_ROUTES = {
  ...
  move_to_inbox:      function(b) { return handleMoveToInbox(b.threadId); },
  move_to_trash:      function(b) { return handleMoveToTrash(b.threadId); },
  star:               function(b) { return handleStar(b.messageId); },
  unstar:             function(b) { return handleUnstar(b.messageId); },
  mark_important:     function(b) { return handleMarkImportant(b.threadId); },
  unmark_important:   function(b) { return handleUnmarkImportant(b.threadId); },
